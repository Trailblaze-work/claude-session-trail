...
When the session ends, it pushes the branch to origin so team members can access session data. Replay sessions in the command line with [claude-replay](https://github.com/Trailblaze-work/claude-replay).
